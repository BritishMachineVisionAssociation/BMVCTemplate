...
{\bf Only}  the bibliography should be {\em excluded} from the page count: {\bf all} appendices must be counted within the {\em 10~pages limit} or supplied as supplementary material.

This is one page more than the version submitted for peer review. The extra page should give you the space to add author information, acknowledgements, and address reviewers' comments. Papers must not have altered margins and formatting from those laid down by this style guide.
