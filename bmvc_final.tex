...
Paper length of the final version must not exceed 9~pages, {\em not counting} the bibliography. 
{\bf Only}  the bibliography should be {\em excluded} from the page count: {\bf all} appendices must be counted within the {\em 9~pages limit} or supplied as supplementary material. Papers must not have altered margins and formatting from those laid down by this style guide.
