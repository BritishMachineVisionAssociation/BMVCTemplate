...
Paper length of the final version must not exceed 14~pages, {\em not counting} the acknowledgement and bibliography.
{\bf Only}  the acknowledgement and bibliography should be {\em excluded} from the page count: {\bf all} appendices must be counted within the {\em 14-page limit} or supplied as supplementary material. Papers must not have altered margins and formatting from those laid down by this style guide.
